...
import com.eltamiuzcom.kafu.Model.myorders.Datum;
...
public class myordersAdapter extends RecyclerView.Adapter<myordersAdapter.ViewHolder> {
    ...
    public myordersAdapter(Context context, List<Datum> data, ItemClickListener mClickListener) {
        this.mInflater = LayoutInflater.from(context);
        this.mData = data;
        this.mClickListener = mClickListener;
    }
// data is passed into the constructor
    public myordersAdapter(Context context, List<Datum> data) {
        this.mInflater = LayoutInflater.from(context);
        this.mData = data;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.title.setText(datum.getItemname());
        holder.price.setText(datum.getPrice()+" ريال");
        if(datum.getItemimgs().size()>0){
            Picasso.get().load(contants.url+datum.getItemimgs().get(0).getImage()).into(holder.imageView);
        }
