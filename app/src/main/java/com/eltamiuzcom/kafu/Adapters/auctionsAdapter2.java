...
import com.eltamiuzcom.kafu.Model.AccountAcutions.Datum;
...
public class auctionsAdapter2 extends BaseAdapter {

    private Context mContext;
    private ArrayList<com.eltamiuzcom.kafu.Model.AccountAcutions.Datum> books;
    // 1
    public auctionsAdapter2(Context context, ArrayList<Datum> books) {
...
// 3
        ...
        // 4
        Picasso.get().load(contants.url+mAuctionmodel.getAuctionimage()).placeholder(R.drawable.fackphoto).into(imageView);
        nameTextView.setText(mAuctionmodel.getTitle());
        timeTextView.setText(mAuctionmodel.getEndDate());
        priceTextView.setText(" "+mAuctionmodel.getPrice()+" ");
